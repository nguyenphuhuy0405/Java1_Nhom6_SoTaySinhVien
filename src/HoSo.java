...
public class HoSo implements  Serializable{
    private String maSV, hoTen, gioiTinh, diaChi, lop, khoa, nganh, sdt, email, soThich,baoLuu,ghiChu;
    ...
    public HoSo(String maSV,String hoTen, String gioiTinh, String diaChi, String lop, String khoa, String nganh, String sdt, String email, String soThich, String baoLuu, String ghiChu, float diemRenLuyen, LocalDate ngaySinh) {
        this.maSV = maSV;
        this.hoTen = hoTen;
