...
import model.TableTK;
import model.TaiKhoan;
import java.util.ArrayList;
import java.util.Collections;
import javax.swing.JOptionPane;
import model.SortByUserName;
...
public class QuanLyTK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSapXep.setBackground(new java.awt.Color(51, 153, 255));
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            ...
            JOptionPane.showConfirmDialog(this, e.toString(),"Thông báo",
    ...
    private void btnSapXepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSapXepActionPerformed
        // TODO add your handling code here:
        try{
            SortByUserName sx = new SortByUserName();
            dstk.sort(sx);
            Clear();
            JOptionPane.showConfirmDialog(this,"Sắp xếp thành công","Thông báo",
                    JOptionPane.CLOSED_OPTION);
            loadTable(dstk);
        } catch (Exception e) {
            JOptionPane.showConfirmDialog(this, e.toString(),"Thông báo",
